...
class AutoencoderKLCogVideoX(ModelMixin, ConfigMixin, FromOriginalModelMixin):
    ...
    def __init__(
        ...
        in_channels: int = 3,
        out_channels: int = 3,
        down_block_types: Union[Tuple[str],List[str]] = (
            "CogVideoXDownBlock3D",
            "CogVideoXDownBlock3D",
            "CogVideoXDownBlock3D",
            "CogVideoXDownBlock3D",
        ),
        up_block_types: Union[Tuple[str],List[str]] = (
            "CogVideoXUpBlock3D",
            "CogVideoXUpBlock3D",
            "CogVideoXUpBlock3D",
            "CogVideoXUpBlock3D",
        ),
        block_out_channels: Union[Tuple[int],List[int]] = (128, 256, 256, 512),
        ...
        latents_mean = None, # type: ignore
        latents_std = None, # type: ignore
        force_upcast = True,
